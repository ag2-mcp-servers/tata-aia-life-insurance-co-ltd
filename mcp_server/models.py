...
class CertificateParameters(BaseModel):
    ...
    UDF1: str = Field(..., description='Policy Number', examples=['C000000013'])
    UDF2: str = Field(..., description='Insured DOB', examples=['21-11-2006'])
...
class CertificateParameters1(BaseModel):
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    PI_DOB: str = Field(..., description='Date of Birth', examples=['28-01-2016'])
    PI_FIN_YEAR: str = Field(
        ..., description='Financial Year', examples=['Previous Year, Current Year']
    )
    PI_POLICYNBR: str = Field(..., description='Policy No', examples=['C000000217'])


class PrcptCertificatePostRequest(BaseModel):
...
class PrcptCertificatePostResponse(BaseModel):
...
class PrcptCertificatePostResponse1(BaseModel):
...
class PrcptCertificatePostResponse2(BaseModel):
...
class PrcptCertificatePostResponse3(BaseModel):
...
class PrcptCertificatePostResponse4(BaseModel):
...
class PrcptCertificatePostResponse5(BaseModel):
...
class PrcptCertificatePostResponse6(BaseModel):
